		...
		public void gameLevel(int level) {
			...
			if (level == 1) {
				...
				Thread job = new Thread(() -> {
					...
					System.out.println("                                       " + x[b1 - 1]);
					System.out
							.println("                └============= 햄버거가 ＼＼\\\\୧( ⁼̴̶̤̀ω⁼̴̶̤́ )૭ //／／ 완성 =============┘");
				...
				System.out.println("                ┌============= 햄버거 ＼＼\\\\୧( ⁼̴̶̤̀ω⁼̴̶̤́ )૭ //／／ 주문! =============┐");
				// Level 2
				for (int i = 0; i < 1; i++) {
					System.out.println("                                       " + x[b1 - 1]);
					for (int j = 0; j < (1 * (Math.random())); j++) {
				...
				System.out.println("                └============= 햄버거가 ＼＼\\\\୧( ⁼̴̶̤̀ω⁼̴̶̤́ )૭ //／／ 주문! =============┘");
				try {
					for (int i = 0; i < hbg.getBreadNum().length; i++) {
						System.out.println("( ˙⤙˙ ) 빵을 선택해 주세요 ( ˙⤙˙ )");
						String num = hbg.getbreads(scanner.nextInt());
				...
				countLevel = loginUser.getUserLever();
				System.out.println("                ┌============= 햄버거 ＼＼\\\\୧( ⁼̴̶̤̀ω⁼̴̶̤́ )૭ //／／ 완성 =============┐");
				System.out.println("                     " + x[b1 - 1] + "         " + x[b2 - 1] + "        " + x[b3 - 1]);
				System.out.println("                     " + y[p1 - 1] + "      " + y[p6 - 1] + "       " + y[p11 - 1]);
				System.out.println("                     " + y[p2 - 1] + "      " + y[p7 - 1] + "       " + y[p12 - 1]);
				System.out.println("                     " + y[p3 - 1] + "      " + y[p8 - 1] + "       " + y[p13 - 1]);
				System.out.println("                     " + y[p4 - 1] + "      " + y[p9 - 1] + "       " + y[p14 - 1]);
				System.out.println("                     " + y[p5 - 1] + "      " + y[p10 - 1] + "       " + y[p15 - 1]);
				System.out.println("                     " + x[b1 - 1] + "         " + x[b2 - 1] + "        " + x[b3 - 1]);
				System.out.println("                └============= 햄버거가 ＼＼\\\\୧( ⁼̴̶̤̀ω⁼̴̶̤́ )૭ //／／ 완성 ============┘");
				...
				System.out.println("                ┌============= 햄버거 ＼＼\\\\୧( ⁼̴̶̤̀ω⁼̴̶̤́ )૭ //／／ 완성 =============┐");
				System.out.println("                       " + x[b1 - 1] + "        " + x[b2 - 1] + "        " + x[b3 - 1]);
				System.out.println("                       " + y[p1 - 1] + "       " + y[p8 - 1] + "       " + y[p15 - 1]);
				System.out.println("                       " + y[p2 - 1] + "       " + y[p9 - 1] + "       " + y[p16 - 1]);
				System.out.println("                       " + y[p3 - 1] + "       " + y[p10 - 1] + "       " + y[p17 - 1]);
				System.out.println("                       " + y[p4 - 1] + "       " + y[p11 - 1] + "       " + y[p18 - 1]);
				System.out.println("                       " + y[p5 - 1] + "       " + y[p12 - 1] + "       " + y[p19 - 1]);
				System.out.println("                       " + y[p6 - 1] + "       " + y[p13 - 1] + "       " + y[p20 - 1]);
				System.out.println("                       " + y[p7 - 1] + "       " + y[p14 - 1] + "       " + y[p21 - 1]);
				System.out.println("                       " + x[b1 - 1] + "        " + x[b2 - 1] + "        " + x[b3 - 1]);
				System.out.println("                └============= 햄버거가 ＼＼\\\\୧( ⁼̴̶̤̀ω⁼̴̶̤́ )૭ //／／ 완성 ============┘");
				loginUser.setBurgerNum(count += 3);
				loginUser.getUserLever();
