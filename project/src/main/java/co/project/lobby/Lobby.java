...
//		}
				...
				if (loginUser.getUserLever() == 1) {
					...
					case 1:
						...
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 35) + 5);
							...
							try {
								for (int i = 0; i < hbg.getBreadNum().length; i++) {
									...
									if (x[b1 - 1].equals(num)) {
										...
										countMoney = loginUser.getMoney();
										System.out.println(hbgMoney + "원 마이너스");
										loginUser.setMoney(countMoney -= hbgMoney);
									}
								}
								for (int i = 0; i < hbg.getBreadNum().length; i++) {
							...
							// 돈, 버거갯수, 레벨 카운트
							countMoney = loginUser.getMoney();
							System.out.println(hbgMoney);
							System.out.println(hbgMoney + "원 받았습니다.");
							loginUser.setMoney(countMoney += hbgMoney);
					...
					case 1:
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 40) + 5);
					...
					case 1:
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 45) + 5);
					...
					case 1:
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 50) + 5);
					...
					case 1:
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 55) + 5);
					...
					case 1:
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 60) + 5);
					...
					case 1:
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 65) + 5);
					...
					case 1:
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 70) + 5);
							...
							try {
								...
								for (int i = 0; i < 3; i++) {
									...
									if (y[p7 - 1].equals(num) && y[p8 - 1].equals(num1) && y[p9 - 1].equals(num2)
											&& y[p10 - 1].equals(num3) && y[p11 - 1].equals(num4)
											&& y[p12 - 1].equals(num5)) {
										break;
									} else {
										System.out.println("( ॱヘॱ ) 제대로 하십쇼 예? ( ॱヘॱ )");
					...
					case 1:
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 75) + 5);
					...
					case 1:
						do {
							...
							int countLevel = 0;
							int countMoney = 0;
							int hbgMoney = (int) ((Math.random() * 100) + 5);
							...
							try {
								...
								for (int i = 0; i < 3; i++) {
									...
									if (y[p1 - 1].equals(num) && y[p2 - 1].equals(num1) && y[p3 - 1].equals(num2)
											&& y[p4 - 1].equals(num3) && y[p5 - 1].equals(num4)
											&& y[p6 - 1].equals(num5) && y[p7 - 1].equals(num6)) {
										break;
									} else {
										System.out.println("( ॱヘॱ ) 제대로 하십쇼 예? ( ॱヘॱ )");
										countMoney = loginUser.getMoney();
								...
								for (int i = 0; i < 3; i++) {
									...
									if (y[p8 - 1].equals(num) && y[p9 - 1].equals(num1) && y[p10 - 1].equals(num2)
											&& y[p11 - 1].equals(num3) && y[p12 - 1].equals(num4)
											&& y[p13 - 1].equals(num5) && y[p14 - 1].equals(num6)) {
										break;
									} else {
										System.out.println("( ॱヘॱ ) 제대로 하십쇼 예? ( ॱヘॱ )");
										countMoney = loginUser.getMoney();
								...
								for (int i = 0; i < 3; i++) {
									...
									if (y[p15 - 1].equals(num) && y[p16 - 1].equals(num1) && y[p17 - 1].equals(num2)
											&& y[p18 - 1].equals(num3) && y[p19 - 1].equals(num4)
											&& y[p20 - 1].equals(num5) && y[p21 - 1].equals(num6)) {
										break;
									} else {
										System.out.println("( ॱヘॱ ) 제대로 하십쇼 예? ( ॱヘॱ )");
										countMoney = loginUser.getMoney();
							...
							System.out.println("                       " + x[b1 - 1] + "          " + x[b2 - 1]
									+ "        " + x[b3 - 1]);
							System.out.println("                       " + y[p1 - 1] + "        " + y[p8 - 1] + "       "
									+ y[p15 - 1]);
							System.out.println("                       " + y[p2 - 1] + "        " + y[p9 - 1] + "       "
									+ y[p16 - 1]);
							System.out.println("                       " + y[p3 - 1] + "       " + y[p10 - 1]
									+ "       " + y[p17 - 1]);
							System.out.println("                       " + y[p4 - 1] + "       " + y[p11 - 1]
									+ "       " + y[p18 - 1]);
							System.out.println("                       " + y[p5 - 1] + "        " + y[p12 - 1]
									+ "       " + y[p19 - 1]);
							System.out.println("                       " + y[p6 - 1] + "        " + y[p13 - 1]
									+ "       " + y[p20 - 1]);
							System.out.println("                       " + y[p7 - 1] + "        " + y[p14 - 1]
									+ "       " + y[p21 - 1]);
							System.out.println("                       " + x[b1 - 1] + "          " + x[b2 - 1]
									+ "        " + x[b3 - 1]);
							System.out.println(
	...
	public void gameEx() {
		...
		System.out.println("                                레벨에따라 벌 수 있는 금액이 증가한다.            ");
